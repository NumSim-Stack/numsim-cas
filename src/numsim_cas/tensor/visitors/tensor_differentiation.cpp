...
=======
      std::iota(reorder.begin(), reorder.begin() + static_cast<std::ptrdiff_t>(free_lhs), std::size_t{0});
      // free_rhs slots
      std::iota(reorder.begin() + static_cast<std::ptrdiff_t>(free_lhs),
                reorder.begin() + static_cast<std::ptrdiff_t>(free_lhs + free_rhs), free_lhs + m_rank_arg);
      // rank_arg slots at end
      std::iota(reorder.begin() + static_cast<std::ptrdiff_t>(free_lhs + free_rhs), reorder.end(), free_lhs);
...
=======
  std::iota(extended.begin() + static_cast<std::ptrdiff_t>(indices.size()), extended.end(), indices.size());
>>>>>>> origin/move_to_virtual
...
=======
    std::iota(new_lhs_idx.begin() + static_cast<std::ptrdiff_t>(seq_lhs.size()), new_lhs_idx.end(),
              rank_lhs + rank_rhs);
>>>>>>> origin/move_to_virtual
...
=======
    std::iota(new_rhs_idx.begin() + static_cast<std::ptrdiff_t>(seq_rhs.size()), new_rhs_idx.end(),
              rank_lhs + rank_rhs);
>>>>>>> origin/move_to_virtual
