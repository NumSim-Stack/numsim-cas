...
public:
  ...
  void operator()(tensor_symmetry const &v) override { check(v.expr()); }
  void operator()(tensor_deviatoric const &v) override { check(v.expr()); }
  void operator()(tensor_volumetric const &v) override { check(v.expr()); }
