...
struct visitor_simpilify_foo1 final : public visitor_simpilify_base,
                                      public visitor {
  explicit visitor_simpilify_foo1(foo1 const &data) : m_data(data) {}
  explicit visitor_simpilify_foo1(visitor_simpilify_foo1 const &data)
      : m_data(data.m_data) {}
...
struct visitor_simpilify_foo2 final : public visitor_simpilify_base,
                                      public visitor {
...
struct visitor_simpilify_foo3 final : public visitor_simpilify_base,
                                      public visitor {
...
struct visitor_simpilify_foo4 final : public visitor_simpilify_base,
                                      public visitor {
...
struct make_visitor_simpilify final : public visitor {
  inline void operator()(foo1 &data) noexcept override {
    m_data = std::make_unique<visitor_simpilify_foo1>(data);
  };
  inline void operator()(foo2 &data) noexcept override {
    m_data = std::make_unique<visitor_simpilify_foo2>(data);
  };
  inline void operator()(foo3 &data) noexcept override {
    m_data = std::make_unique<visitor_simpilify_foo3>(data);
  };
  inline void operator()(foo4 &data) noexcept override {
    m_data = std::make_unique<visitor_simpilify_foo4>(data);
  };
...
struct visitor_simpilify_foo1_var final : public visitor {
  ...
  visitor_simpilify_foo1_var const &
  operator=(visitor_simpilify_foo1_var const &data) {
    m_data = data.m_data;
    return *this;
  }
...
struct visitor_simpilify_foo2_var final : public visitor {
  ...
  visitor_simpilify_foo2_var const &
  operator=(visitor_simpilify_foo2_var const &data) {
    m_data = data.m_data;
    return *this;
  }
...
struct visitor_simpilify_foo3_var final : public visitor {
  ...
  visitor_simpilify_foo3_var const &
  operator=(visitor_simpilify_foo3_var const &data) {
    m_data = data.m_data;
    return *this;
  }
...
struct visitor_simpilify_foo4_var final : public visitor {
  ...
  visitor_simpilify_foo4_var const &
  operator=(visitor_simpilify_foo4_var const &data) {
    m_data = data.m_data;
    return *this;
  }
...
struct make_visitor_simpilify_var final : public visitor {
  using var = std::variant<
      visitor_simpilify_foo1_var, visitor_simpilify_foo2_var,
      visitor_simpilify_foo3_var,
      visitor_simpilify_foo4_var>; //,visitor_simpilify_foo2,visitor_simpilify_foo3,visitor_simpilify_foo4>;
...
struct visitor_simpilify {
  ...
  inline void operator()(visitor_simpilify_foo1_var &data) noexcept {
    m_data.accept(data);
    number = data.number;
  };
  inline auto operator()(visitor_simpilify_foo2_var &data) noexcept {
    m_data.accept(data);
    number = data.number;
  };
  inline auto operator()(visitor_simpilify_foo3_var &data) noexcept {
    m_data.accept(data);
    number = data.number;
  };
  inline auto operator()(visitor_simpilify_foo4_var &data) noexcept {
    m_data.accept(data);
    number = data.number;
  };
...
struct foo_base {
  ...
  foo_base(foo_base &&data)
      : _rhs(std::move(data._rhs)), _lhs(std::move(data._lhs)),
...
struct visitor_simpilify_foo1 // final : public visitor_simpilify_base, public
                              // visitor
{
  explicit visitor_simpilify_foo1(foo1 const &data) : m_data(data) {}
  explicit visitor_simpilify_foo1(visitor_simpilify_foo1 const &data)
...
struct visitor_simpilify_foo2 // final : public visitor_simpilify_base, public
                              // visitor
{
  explicit visitor_simpilify_foo2(foo2 const &data) : m_data(data) {}
  explicit visitor_simpilify_foo2(visitor_simpilify_foo2 const &data)
      : m_data(data.m_data) {}
  inline auto operator()(foo1 &) noexcept { return rand(); };
  inline auto operator()(foo2 &) noexcept { return rand(); };
  inline auto operator()(foo3 &) noexcept { return rand(); };
...
struct visitor_simpilify_foo3 // final : public visitor_simpilify_base, public
                              // visitor
{
  explicit visitor_simpilify_foo3(foo3 const &data) : m_data(data) {}
  explicit visitor_simpilify_foo3(visitor_simpilify_foo3 const &data)
      : m_data(data.m_data) {}
  inline auto operator()(foo1 &) noexcept { return rand(); };
  inline auto operator()(foo2 &) noexcept { return rand(); };
  inline auto operator()(foo3 &) noexcept { return rand(); };
...
struct visitor_simpilify_foo4 // final : public visitor_simpilify_base, public
                              // visitor
{
  explicit visitor_simpilify_foo4(foo4 const &data) : m_data(data) {}
  explicit visitor_simpilify_foo4(visitor_simpilify_foo4 const &data)
      : m_data(data.m_data) {}
  explicit visitor_simpilify_foo4(visitor_simpilify_foo4 &&data)
      : m_data(data.m_data) {}
  inline auto operator()(foo1 &) noexcept { return rand(); };
  inline auto operator()(foo2 &) noexcept { return rand(); };
  inline auto operator()(foo3 &) noexcept { return rand(); };
...
struct make_visitor_simpilify // final : public visitor
{
  using var = std::variant<visitor_simpilify_foo1, visitor_simpilify_foo2,
                           visitor_simpilify_foo3, visitor_simpilify_foo4>;
  inline var operator()(foo1 &data) noexcept {
    return var(std::in_place_index<0>, visitor_simpilify_foo1(data));
  };
  inline var operator()(foo2 &data) noexcept {
    return var(std::in_place_index<1>, visitor_simpilify_foo2(data));
  };
  inline var operator()(foo3 &data) noexcept {
    return var(std::in_place_index<2>, visitor_simpilify_foo3(data));
  };
  inline var operator()(foo4 &data) noexcept {
    return var(std::in_place_index<3>, visitor_simpilify_foo4(data));
  };
};

struct visitor_simpilify {
  visitor_simpilify(variant &data) : m_data(data) {}
  inline auto operator()(visitor_simpilify_foo1 &data) noexcept {
    return std::visit(data, m_data);
  };
  inline auto operator()(visitor_simpilify_foo2 &data) noexcept {
    return std::visit(data, m_data);
  };
  inline auto operator()(visitor_simpilify_foo3 &data) noexcept {
    return std::visit(data, m_data);
  };
  inline auto operator()(visitor_simpilify_foo4 &data) noexcept {
    return std::visit(data, m_data);
  };
