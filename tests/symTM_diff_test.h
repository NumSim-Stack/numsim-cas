...
//   auto
//   [X,Y,Z]{numsim::cas::make_tensor_variable<double>(numsim::cas::tuple("X",
//   3, 2),numsim::cas::tuple("Y", 3, 2),numsim::cas::tuple("Z", 3, 2))}; auto
//   expr = X; auto dexpr = diff(expr, X);
//   EXPECT_EQ("basis_change<1,3,2,4>(simple_outer(I, I))",
//   std::to_string(dexpr));
