...
binary_add_tensor_to_scalar_simplify(ExprTypeLHS &&lhs, ExprTypeRHS &&rhs) {
  return visit(
      tensor_to_scalar_detail::simplifier::add_base<ExprTypeLHS, ExprTypeRHS>(
...
binary_sub_tensor_to_scalar_simplify(ExprTypeLHS &&lhs, ExprTypeRHS &&rhs) {
  return visit(
      tensor_to_scalar_detail::simplifier::sub_base<ExprTypeLHS, ExprTypeRHS>(
          std::forward<ExprTypeLHS>(lhs), std::forward<ExprTypeRHS>(rhs)),
      *lhs);
}
...
binary_mul_tensor_to_scalar_simplify(ExprTypeLHS &&lhs, ExprTypeRHS &&rhs) {
  return visit(
      tensor_to_scalar_detail::simplifier::mul_base<ExprTypeLHS, ExprTypeRHS>(
          std::forward<ExprTypeLHS>(lhs), std::forward<ExprTypeRHS>(rhs)),
      *lhs);
}
...
binary_div_tensor_to_scalar_simplify(ExprTypeLHS &&lhs, ExprTypeRHS &&rhs) {
  return visit(
      tensor_to_scalar_detail::simplifier::div_base<ExprTypeLHS, ExprTypeRHS>(
          std::forward<ExprTypeLHS>(lhs), std::forward<ExprTypeRHS>(rhs)),
      *lhs);
}
...
struct operator_overload<expression_holder<tensor_to_scalar_expression>,
  ...
  [[nodiscard]] static constexpr inline auto add(ExprTypeLHS &&lhs,
                                                 ExprTypeRHS &&rhs) {
    return binary_add_tensor_to_scalar_simplify(std::forward<ExprTypeLHS>(lhs),
  ...
  [[nodiscard]] static constexpr inline auto mul(ExprTypeLHS &&lhs,
                                                 ExprTypeRHS &&rhs) {
    return binary_mul_tensor_to_scalar_simplify(std::forward<ExprTypeLHS>(lhs),
                                                std::forward<ExprTypeRHS>(rhs));
  }
  ...
  [[nodiscard]] static constexpr inline auto sub(ExprTypeLHS &&lhs,
                                                 ExprTypeRHS &&rhs) {
    return binary_sub_tensor_to_scalar_simplify(std::forward<ExprTypeLHS>(lhs),
                                                std::forward<ExprTypeRHS>(rhs));
  }
  ...
  [[nodiscard]] static constexpr inline auto div(ExprTypeLHS &&lhs,
                                                 ExprTypeRHS &&rhs) {
    return binary_div_tensor_to_scalar_simplify(std::forward<ExprTypeLHS>(lhs),
                                                std::forward<ExprTypeRHS>(rhs));
  }
};
