...
public:
  using base = binary_op<tensor_to_scalar_div<ValueType>,
                         tensor_to_scalar_expression<ValueType>>;
  using base_expr = expression_crtp<tensor_to_scalar_div<ValueType>,
                                    tensor_to_scalar_expression<ValueType>>;
  using base::base;

  tensor_to_scalar_div() : base() {}
  ~tensor_to_scalar_div() = default;
  tensor_to_scalar_div(tensor_to_scalar_div const &data)
      : base(static_cast<base const &>(data)) {}
  tensor_to_scalar_div(tensor_to_scalar_div &&data)
