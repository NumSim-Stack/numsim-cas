...
template <typename ExprLHS, typename SeqLHS, typename ExprRHS,
          typename SeqRHS /*,
std::enable_if_t<std::is_base_of_v<tensor_expression<typename
remove_cvref_t<ExprLHS>::value_type>, get_type_t<ExprLHS>>,bool> = true,
std::enable_if_t<std::is_base_of_v<tensor_expression<typename
remove_cvref_t<ExprRHS>::value_type>, get_type_t<ExprRHS>>,bool> = true,
std::enable_if_t<std::is_same_v<std::vector<std::size_t>, SeqLHS>, bool> =
true, std::enable_if_t<std::is_same_v<std::vector<std::size_t>, SeqRHS>, bool>
= true*/>
constexpr inline auto inner_product(ExprLHS &&lhs, SeqLHS &&lhs_indices,
                                    ExprRHS &&rhs, SeqRHS &&rhs_indices) {
...
true, std::enable_if_t<std::is_same_v<std::vector<std::size_t>, SeqRHS>, bool>
= true*/>
constexpr inline auto outer_product(ExprLHS &&lhs, SeqLHS &&lhs_indices,
                                    ExprRHS &&rhs, SeqRHS &&rhs_indices) {
  using ValueType = typename remove_cvref_t<ExprLHS>::value_type;
