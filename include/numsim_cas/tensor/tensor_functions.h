...
//   return visit(
//       tensor_with_scalar_detail::simplifier::mul_base<ExprTypeLHS,
//       ExprTypeRHS>(
//           std::forward<ExprTypeLHS>(lhs), std::forward<ExprTypeRHS>(rhs)),
//       *lhs);
// }
...
//   return visit(
//       tensor_with_scalar_detail::simplifier::div_base<ExprTypeLHS,
//       ExprTypeRHS>(
//           std::forward<ExprTypeLHS>(lhs), std::forward<ExprTypeRHS>(rhs)),
//       *lhs);
// }
...
//                       typename
//                       numsim::cas::remove_cvref_t<Expr>::value_type>,
...
//   if (expr.get().rank() == 2) {
//     return make_expression<tensor_deviatoric>(
...
// template <typename ExprLHS, typename ExprRHS>
// constexpr inline auto inner_product(ExprLHS &&lhs, sequence const
// &lhs_indices,
//                                     ExprRHS &&rhs,
