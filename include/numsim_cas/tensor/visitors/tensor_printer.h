...
private:
  ...
  bool m_first{
      false}; ///< Indicates if this is the first expression in a sequence.
};
...
//  void apply(expression_holder<tensor_expression<ValueType>> && expr, bool
//  first = false) {
//    if(expr){
...
//      m_first = false;
//      m_stream << "(";
//      //static_cast<VisitableTensor_t<ValueType>
//      &>(visitable.expr()).accept(*this); m_stream << ")";
//    } else {
//      m_stream << visitable.name();
//    }
//  }
...
////    for (auto& child : visitable) {
////      static_cast<VisitableTensor_t<ValueType>
///&>(child.get()).accept(*this); /      if (idx++ < (size - 1)) { /
/// if(!negative[idx]){ /          m_stream << "+"; /        } /      } /    }
//  }
...
//  virtual void operator()(kronecker_delta<ValueType> &visitable) { m_stream <<
//  "I"; }
...
//    for (auto& child : visitable) {
//      //static_cast<VisitableTensor_t<ValueType>
//      &>(child.get()).accept(*this); if(&child != &visitable.back()){
//        m_stream << ", ";
//      }
//    }
//    m_stream << ")";
...
//    m_stream << "(";
//    //static_cast<VisitableTensor_t<ValueType>
//    &>(visitable.expr_rhs().get()).accept(*this); m_stream << ")/"; m_stream
...
//    m_stream << "sym(";
//    //static_cast<VisitableTensor_t<ValueType>
//    &>(visitable.expr().get()).accept(*this); m_stream << ")";
//  }
...
//                                             [&sep = m_sepperator, &stream =
//                                             m_stream](std::size_t i) {
//                                               stream << sep;
//                                               stream << i + 1;
//                                               sep = ",";
//                                             }};
