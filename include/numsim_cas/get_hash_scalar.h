...
//   }
//   auto operator()(scalar_negative const &expr) {
//     return expr.expr().get().hash_value();
//   }
// };

// auto get_hash_value(expression_holder<scalar_expression> const &expr) {
...
// //  inline std::size_t operator()(tensor_scalar_mul<ValueType> const&
// visitor){
// //    std::size_t seed{0};
...
// //   std::size_t operator()(const symTM::n_ary_tree<ExprType>& add_expr)
// const {
// //     return std::visit(symTM::get_hash<ValueType>(), *add_expr);
// //   }
// // };
