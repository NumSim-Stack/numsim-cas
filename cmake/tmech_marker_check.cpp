...
//
// numsim_cas requires the `inverse_wrapper_base` rewrite of tmech
// (introduced in petlenz/tmech commit db5d8aa, the version pinned by this
// project — see #283/#248): without it, rank-4 `tmech::inv` silently
// returns NaN through the Voigt path. This file is a `try_compile` probe
// used by the top-level CMakeLists.txt to reject stale system installs
// that would otherwise shadow the pinned FetchContent copy.
//
